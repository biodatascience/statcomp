...
* [BIOS 663 & 760 (or 762 if Bios DrPH)](https://sph.unc.edu/bios/courses/) --- **Note this has changed.**
...
(40%) a final presentation (20%), and weekly homework assignments
(40% total) will make up the final grade for the course.
...
*Homework policy* - students are allowed and encouraged to talk about
ideas and approaches to homework problems in groups, though students
should write up the code for the assignments **independently**.
