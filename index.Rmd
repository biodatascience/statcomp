...
| Jan 28, 29 | Large data | `large` | [hw](#) | [datatable](large/datatable.html) | Reading with `data.table` |
| | | | | [sqlite](large/sqlite.html) | Reading with `RSQLite` |
| | | | | [hdf5](large/hdf5.html) | Reading with `rhdf5` |
